...
namespace SplatterServer
{
    ...
    namespace GamePacket
    {
        namespace Incoming
        {
            ...
            {
                public static void Jump(SplatterServer.Player player, MemoryStream inStream)
                {
                ...
                public static void God(SplatterServer.Player player, MemoryStream inStream)
                {
                    if (player.ActiveArena == null || player.ActiveArenaPlayer == null || !player.IsAdmin) return;
                ...
                public static void Yank(SplatterServer.Player player, MemoryStream inStream)
                {
                    if (player.ActiveArena == null || player.ActiveArenaPlayer == null || !player.IsAdmin) return;
                ...
                public static void PlayerMoveState(SplatterServer.Player player, MemoryStream inStream)
                {
                ...
                public static void PlayerMoveStateShort(SplatterServer.Player player, MemoryStream inStream)
                {
                    if (player.ActiveArena == null || player.ActiveArenaPlayer == null || player.Flags.HasFlag(PlayerFlag.Hidden)) return;
                ...
                public static void TappedAtShrine(SplatterServer.Player player)
                {
                ...
                public static void CalledGhost(SplatterServer.Player player, MemoryStream inStream)
                {
                    if (player.ActiveArena == null || player.ActiveArenaPlayer == null) return;
                ...
                public static void CastEffect(SplatterServer.Player player, MemoryStream inStream)
                {
                    if (player.ActiveArena == null || player.ActiveArenaPlayer == null) return;
                ...
                public static void CastTargeted(SplatterServer.Player player, MemoryStream inStream)
                {
                    if (player.ActiveArena == null || player.ActiveArenaPlayer == null) return;
                ...
                public static void CastSign(SplatterServer.Player player, MemoryStream inStream)
                {
                    if (player.ActiveArena == null || player.ActiveArenaPlayer == null) return;
                ...
                public static void CastBolt(SplatterServer.Player player, MemoryStream inStream)
                {
                    if (player.ActiveArena == null || player.ActiveArenaPlayer == null) return;
                ...
                public static void CastProjectile(SplatterServer.Player player, MemoryStream inStream)
                {
                    if (player.ActiveArena == null || player.ActiveArenaPlayer == null) return;
                ...
                public static void CastWall(SplatterServer.Player player, MemoryStream inStream)
                {
                    if (player.ActiveArena == null || player.ActiveArenaPlayer == null) return;
                ...
                public static void CastDispell(SplatterServer.Player player, MemoryStream inStream)
                {
                    if (player.ActiveArena == null || player.ActiveArenaPlayer == null) return;
                ...
                public static void ThinDamage(SplatterServer.Player player, MemoryStream inStream)
                {
                    if (player.ActiveArena == null || player.ActiveArenaPlayer == null) return;
                ...
                public static void ActivatedTrigger(SplatterServer.Player player, MemoryStream inStream)
                {
                    if (player.ActiveArena == null || player.ActiveArenaPlayer == null) return;
            ...
            {
                public static void Save(SplatterServer.Player player, MemoryStream inStream)
                {
                    SplatterServer.Character.Save(player, new SplatterServer.Character(inStream));
                }
                public static void Delete(SplatterServer.Player player, MemoryStream inStream)
                {
                    ...
                    SplatterServer.Character deleteCharacter = SplatterServer.Character.LoadByNameAndAccountId(player, name);
            ...
            {
                public static void Authenticate(SplatterServer.Player player, MemoryStream inStream)
                {
                ...
                public static void Disconnect(SplatterServer.Player player)
                {
            ...
            {
                public static void Heartbeat(SplatterServer.Player player, MemoryStream inStream)
                {
                ...
                public static void HasEnteredWorld(SplatterServer.Player player)
                {
                    Network.Send(player, Outgoing.Player.HasEnteredWorld());
                }
                public static void EnterWorld(SplatterServer.Player player, MemoryStream inStream)
                {
                    ...
                    SplatterServer.World.PlayerEnteredWorld(player, worldId, team, charName);
                }
                public static void ExitWorld(SplatterServer.Player player)
                {
                    if (player.ActiveArena == null || player.ActiveArenaPlayer == null) return;

                    SplatterServer.Arena arena = player.ActiveArena;
                ...
                public static void Chat(SplatterServer.Player player, MemoryStream inStream)
                {
                    ...
                    SplatterServer.World.ProcessChatMessage(player, target, targetType, message);
                }
                public static void SwitchedToTableOrArena(SplatterServer.Player player, MemoryStream inStream)
                {
                    inStream.Seek(5, SeekOrigin.Begin);
                ...
                public static void InviteToTable(MemoryStream inStream)
                {
                    ...
                    for (Int16 i = 1; i < bitArray.Count; i++)
                    {
                        ...
                        SplatterServer.Player targetPlayer = PlayerManager.Players.FindById(i);
            ...
            {
                public static void RequestCharacterInSlot(SplatterServer.Player player, MemoryStream inStream)
                {
                ...
                public static void IsNameTaken(SplatterServer.Player player, MemoryStream inStream)
                {
                    ...
                    Boolean isTaken = SplatterServer.Character.IsNameTaken(name);
                    Network.Send(player, Outgoing.Study.IsNameTaken(player, name, isTaken));
                }
                public static void IsNameValid(SplatterServer.Player player, MemoryStream inStream)
                {
                    Byte[] tBuffer = new Byte[12];
                    inStream.Seek(2, SeekOrigin.Current);
                    inStream.Read(tBuffer, 0, 12);
                    ...
                    Boolean isValid = SplatterServer.Character.IsNameValid(name, false);
                    Network.Send(player, Outgoing.Study.IsNameValid(player, name, isValid));
                }
                public static void HighScores(SplatterServer.Player player, MemoryStream inStream)
                {
                    inStream.Seek(5, SeekOrigin.Begin);
            ...
            {
                public static void RequestedPlayer(SplatterServer.Player player, MemoryStream inStream)
                {
                    Byte[] tBuffer = new Byte[2];
                    inStream.Seek(4, SeekOrigin.Begin);
                    ...
                    {
                        SplatterServer.Player tPlayer = PlayerManager.Players.FindById(tPlayerId);
                ...
                public static void RequestedAllPlayers(SplatterServer.Player player)
                {
                    ...
                    else
                    {
                        lock (PlayerManager.Players.SyncRoot)
                        {
                            ...
                            {
                                SplatterServer.Player p = PlayerManager.Players[i];
                ...
                public static void RequestedArena(SplatterServer.Player player, MemoryStream inStream)
                {
                    inStream.Seek(5, SeekOrigin.Begin);
                    Byte arenaId = (Byte)inStream.ReadByte();

                    SplatterServer.Arena arena = ArenaManager.Arenas.FindById(arenaId);
                ...
                public static void RequestedAllArenas(SplatterServer.Player player)
                {
                    MemoryStream outStream = null;
                    Int32 j = 0;
                    ...
                    lock (ArenaManager.Arenas.SyncRoot)
                    {
                        ...
                        {
                            SplatterServer.Arena a = ArenaManager.Arenas[i];
                            if (a == null) continue;
                ...
                public static void RequestedArenaStatus(SplatterServer.Player player)
                {
                    for (int i = 0; i < ArenaManager.Arenas.Count; i++)
                    {
                        SplatterServer.Arena arena = ArenaManager.Arenas[i];
                        if (arena == null) continue;

                        Network.Send(player, Outgoing.World.ArenaState(arena, player));
                    }
                }
                public static void CreateTable(SplatterServer.Player player, MemoryStream inStream)
                {
                    inStream.Seek(2, SeekOrigin.Begin);
                ...
                public static void RequestedAllTables(SplatterServer.Player player)
                {
					...
					SplatterServer.World.SendSystemMessage(player, String.Format("Message of the Day: {0}", Properties.Settings.Default.MessageOfTheDay));

                    if (player.ActiveCharacter.AvailableStatPoints > 0)
                    {
                        SplatterServer.World.SendSystemMessage(player, "You have unspent stat points.  Go to the website to spend them.");
                    }
                    
                    if (player.Flags.HasFlag(PlayerFlag.ChatDisabled))
                    {
                        SplatterServer.World.SendSystemMessage(player, "Your chat is currently disabled. Type !mute to toggle.");
                    }

                    if (player.Flags.HasFlag(PlayerFlag.ExpLocked))
                    {
                        SplatterServer.World.SendSystemMessage(player, "Your exp is currently locked. Type !lockexp to toggle.");
                    }

                    if (player.Flags.HasFlag(PlayerFlag.Muted))
                    {
                        SplatterServer.World.SendSystemMessage(player, "You are currently muted and may not chat in public channels.");
                    }

                    if (player.Flags.HasFlag(PlayerFlag.MusicDisabled))
                    {
                        SplatterServer.World.SendSystemMessage(player, "You currently have streaming music disabled. Type !togglemusic to toggle.");
                    }
                }
                public static void CreateArena(SplatterServer.Player player, MemoryStream inStream)
                {
                    inStream.Seek(2, SeekOrigin.Begin);
                ...
                public static void DeleteArena(SplatterServer.Player player, MemoryStream inStream)
                {
                    inStream.Seek(2, SeekOrigin.Begin);
                    ...
                    lock (arena.SyncRoot)
                    {
                        if (arena.ArenaPlayers.Count > 0)
                        {
                            ...
                            {
                                arena.CurrentState = SplatterServer.Arena.State.Ended;
                            }
                        }
                        else
                        {
            ...
            {
                public static void HackNotification(SplatterServer.Player player, MemoryStream inStream)
                {
                    inStream.Seek(2, SeekOrigin.Begin);
                ...
                public static void CheatProgramNotification(SplatterServer.Player player, MemoryStream inStream)
                {
                    inStream.Seek(2, SeekOrigin.Begin);
        ...
        namespace Outgoing
        {
            ...
            public static class Login
            {
                public static MemoryStream Connected(SplatterServer.Player player)
                {
                    MemoryStream outStream = new MemoryStream();
                    outStream.WriteByte(0x00);
            ...
            public static class Player
            {
                public static MemoryStream SendPlayerId(SplatterServer.Player player)
                {
                    MemoryStream outStream = new MemoryStream();
                    outStream.WriteByte(0x00);
                ...
                public static MemoryStream HeartbeatReply(SplatterServer.Player player)
                {
                    MemoryStream outStream = new MemoryStream();
                    outStream.WriteByte(0x00);
                ...
                public static MemoryStream SaveSuccess(SplatterServer.Player player, Byte slot)
                {
                    MemoryStream outStream = new MemoryStream();
                    outStream.WriteByte(0x00);
                ...
                public static MemoryStream SwitchedToTable(SplatterServer.Player player)
                {
                    MemoryStream outStream = new MemoryStream();
                    outStream.WriteByte(0x00);
                ...
                public static MemoryStream Chat(SplatterServer.Player player, Int16 target, ChatType targetType, String message)
                {
                    MemoryStream outStream = new MemoryStream();
                    outStream.WriteByte(0x00);
            ...
            public static class Study
            {
                public static MemoryStream IsNameValid(SplatterServer.Player player, String name, Boolean valid)
                {
                    MemoryStream outStream = new MemoryStream();
                    outStream.WriteByte(0x00);
                ...
                public static MemoryStream IsNameTaken(SplatterServer.Player player, String name, Boolean taken)
                {
                    MemoryStream outStream = new MemoryStream();
                    outStream.WriteByte(0x00);
                ...
                public static MemoryStream SendCharacterInSlot(SplatterServer.Player player, Byte slot, DataTable data)
                {
                    MemoryStream outStream = new MemoryStream();
            ...
            {
				public static void PlaySoundToArena(SplatterServer.Arena arena, GameSound.Sound sound)
                {
                    if (arena == null) return;
                ...
                public static MemoryStream DirectTextMessage(SplatterServer.Player player, String message)
                {
                    MemoryStream outStream = new MemoryStream();
                    outStream.WriteByte(0x00);
                    outStream.WriteByte((Byte)PacketOutFunction.Chat);
            ...
            public static class World
            {
                public static MemoryStream PlayerJoin(SplatterServer.Player player)
                {
                    MemoryStream outStream = new MemoryStream();
                ...
                public static MemoryStream PlayerLeave(SplatterServer.Player player)
                {
                    MemoryStream outStream = new MemoryStream();
                    outStream.WriteByte((Byte) player.PlayerId);
                    outStream.WriteByte((Byte)PacketOutFunction.PlayerLeave);
                ...
                public static MemoryStream PlayerEnterLarge(SplatterServer.Player player, MemoryStream outStream)
                {
                    if (outStream == null)
                    {
                        outStream = new MemoryStream();
                ...
                public static MemoryStream WorldEnterLarge(SplatterServer.Arena arena, MemoryStream outStream)
                {
                    if (outStream == null)
                    {
                        outStream = new MemoryStream();
                ...
                public static MemoryStream ArenaCreated(SplatterServer.Arena arena)
                {
                    MemoryStream outStream = new MemoryStream();
                    outStream.WriteByte(0x00);
                ...
                public static MemoryStream ArenaState(SplatterServer.Arena arena, SplatterServer.Player player)
                {
                    MemoryStream outStream = new MemoryStream();
                    outStream.WriteByte(0x00);

    ...
    public class Arena
    {
        ...
        public void GivePlayerExperience(ArenaPlayer arenaPlayer, Single baseAmount, ArenaPlayer.ExperienceType experienceType)
        {
            ...
            switch (experienceType)
            {
                ...
                {
					arenaPlayer.CombatExp += (Int32)(baseAmount * (Settings.Default.ExpMultiplier + plusBonus));
                    break;
                }
                case ArenaPlayer.ExperienceType.Objective:
                {
					arenaPlayer.ObjectiveExp += (Int32)(baseAmount * (Settings.Default.ExpMultiplier + plusBonus));
                    break;
                }

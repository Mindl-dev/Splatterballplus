...
namespace Helper
{
    public class Grid
    {
        ...
        public Byte MaxTeam0;
        public Byte MaxTeam1;
        public Byte MaxTeam2;
        public Byte MaxTeam3;
        public Byte MaxTeam4;
        ...
        public Grid(Grid grid)
        {
            ...
            MaxTeam0 = grid.MaxTeam0;
            MaxTeam1 = grid.MaxTeam1;
            MaxTeam2 = grid.MaxTeam2;
            MaxTeam3 = grid.MaxTeam3;
            MaxTeam4 = grid.MaxTeam4;
            FlagX = grid.FlagX;
            FlagY = grid.FlagY;
        }
        ...
        public Boolean Load(Int32 gridId)
        {
            try
            {
                ...
                MaxTeam2 = NativeMethods.GetPrivateProfileByte(keyName, "maxteam2", arenaDatFilename);
                MaxTeam3 = NativeMethods.GetPrivateProfileByte(keyName, "maxteam3", arenaDatFilename);
                MaxTeam4 = NativeMethods.GetPrivateProfileByte(keyName, "maxteam4", arenaDatFilename);
                TimeLimit = NativeMethods.GetPrivateProfileInt16(keyName, "opentime", arenaDatFilename);
                FlagX = NativeMethods.GetPrivateProfileByte(keyName, "flagx", arenaDatFilename);
                FlagY = NativeMethods.GetPrivateProfileByte(keyName, "flagy", arenaDatFilename);
                    ...
                    case "door":
                        {
                            ...
                            trigger.MaxRate = NativeMethods.GetPrivateProfileInt32(keyName, "max_angle_rate", TriggerFilename);                                                        
                            break;
                        }
                    ...
                    case "teleport":
                        {
                            ...
                            trigger.OnSound = NativeMethods.GetPrivateProfileInt32(keyName, "on_sound", TriggerFilename);                            
                            break;
                        }
                    case "null":
                        {
